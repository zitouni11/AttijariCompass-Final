...
@Entity
@Table(
        name = "card_pool_transaction",
        indexes = {
                @Index(name = "idx_card_pool_transaction_card_pool_id", columnList = "card_pool_id"),
                @Index(name = "idx_card_pool_transaction_transaction_date", columnList = "transaction_date"),
                @Index(name = "idx_card_pool_transaction_pool_date", columnList = "card_pool_id, transaction_date")
        },
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_card_pool_transaction_pool_external_reference",
                        columnNames = {"card_pool_id", "external_reference"}
                )
        }
)
@Getter
...
@NoArgsConstructor
@AllArgsConstructor
public class CardPoolTransaction {
